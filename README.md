...
> **Historical caution (Vietnam):** One widely cited lesson from U.S. experience in Vietnam is that strategic failure was compounded by **insufficient social and cultural awareness**—misreading local political legitimacy, rural social structures, nationalist motivations, and how communities interpreted security operations and governance programs. Policies designed without this grounded social understanding often produced **unintended second-order effects** (eroding trust, strengthening insurgent narratives, and undermining local partners), **reducing the effectiveness of otherwise superior resources and capabilities**. 
